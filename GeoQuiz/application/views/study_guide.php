			...
			<div class="entry-content cf">
				<div class='world_map_wrap' style='width: 500px; height: 500px;'>
					<div class='world_map_div' style='width: 3500px; height: 1775px; left: 0px; top: 100px; '>
						<img id='world_map' src='../../assets/img/world_map_for_quiz.gif' usemap='#world_map_img_map' style='width: 3500px; height: 1775px;'> 
					</div>
				</div>
				
				<div id='question_area'>
				<h2 id='quiz_heading' class='heading'>Study Guide</h2>
<?php
...
?>		
				...
				<label id='quiz_select' for='quiz_select'>Zoom to continent</label>
				...
				<div class='clear' id='question' style='height: 50px;'></div>
				</div>
